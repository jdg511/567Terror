...
C(s.add('Device:C','C102','1n',(256.54,63.5)), {1:'ADC_MUXED', 2:'GND'})
C(s.add('Device:C','C103','100n',(256.54,83.82)), {1:'3V3', 2:'GND'})
...
for i,(st,x) in enumerate([('STOMP1',33.02),('STOMP2',58.42)]):
    ...
    C(s.add('Device:C', f'C10{4+i}', '100n', (x+10.16, 245.11)), {1:st, 2:'GND'})
C(s.add('74xGxx:74AHCT1G125','U22','74AHCT1G125',(101.6,228.6)),
  {2:'WS_DATA_3V3', 4:'WS_DATA_5V', 1:'GND', 5:'+5V', 3:'GND'})
C(s.add('Device:C','C106','100n',(114.3,245.11)), {1:'+5V', 2:'GND'})
