...
C(s.add('Device:R','R94','220k',(144.78,146.05)), {1:'SVF_BP', 2:'I1_M'})
C(s.add('Device:R','R95','680',(144.78,158.75)), {1:'I1_M', 2:'VREF'})
C(s.add('Amplifier_Operational:LM13700','U11','LM13700',(157.48,127.0),unit=3),
  {3:'I1_P', 4:'I1_M', 5:'I1_OUT', 1:'F_IABC1', 2:None})
C(s.add('Device:C','C61','220p',(170.18,146.05)), {1:'I1_OUT', 2:'VREF'})
C(s.add('Amplifier_Operational:LM13700','U11','LM13700',(185.42,127.0),unit=4), {7:'I1_OUT', 8:'SVF_BP'})
C(s.add('Device:R','R98','10k (buffer DC load)',(198.12,146.05)), {1:'SVF_BP', 2:'GND'})
...
C(s.add('Device:R','R96','220k',(226.06,146.05)), {1:'SVF_LP', 2:'I2_M'})
C(s.add('Device:R','R97','680',(226.06,158.75)), {1:'I2_M', 2:'VREF'})
C(s.add('Amplifier_Operational:LM13700','U11','LM13700',(238.76,127.0),unit=1),
  {14:'I2_P', 13:'I2_M', 12:'I2_OUT', 16:'F_IABC2', 15:None})
C(s.add('Device:C','C62','220p',(251.46,146.05)), {1:'I2_OUT', 2:'VREF'})
C(s.add('Amplifier_Operational:LM13700','U11','LM13700',(266.7,127.0),unit=2), {10:'I2_OUT', 9:'SVF_LP'})
C(s.add('Device:R','R99','10k (buffer DC load)',(281.94,146.05)), {1:'SVF_LP', 2:'GND'})
...
C(s.add('Amplifier_Operational:LM13700','U10','LM13700',(325.12,45.72),unit=2), {10:'GND', 9:None})
C(s.add('Amplifier_Operational:LM13700','U10','LM13700',(325.12,63.5),unit=4), {7:'GND', 8:None})
...
C(s.add('Amplifier_Operational:LM13700','U12','LM13700',(325.12,127.0),unit=4), {7:'GND', 8:None})
