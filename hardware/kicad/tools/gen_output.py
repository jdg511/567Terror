...
# +3dB bell @800Hz Q0.5 - gyrator bell (VALUES TO VERIFY AT REVIEW)
s.text('Bell: gyrator peak +3dB@800 Q0.5 - VERIFY VALUES at review pass.', (121.92, 63.5), 1.5)
C(s.add('Device:R','R102A','12k',(127.0,45.72),angle=90), {1:'H60_OUT', 2:'BELL_N'})
C(s.add('Device:R','R103A','27k',(139.7,63.5)), {1:'BELL_N', 2:'GYR_T'})
C(s.add('Device:C','C72','47n',(152.4,63.5)), {1:'GYR_T', 2:'GYR_B'})
C(s.add('Device:R','R104A','2.2k',(165.1,63.5)), {1:'GYR_B', 2:'VREF'})
C(s.add('Amplifier_Operational:TL074','U14','TL074',(190.5,45.72),unit=2), {5:'BELL_N', 6:'BELL_OUT', 7:'BELL_OUT'})
C(s.add('Device:R','R105A','12k',(203.2,63.5)), {1:'BELL_OUT', 2:'BELL_N'})
...
C(s.add('Amplifier_Operational:LM13700','U15','LM13700',(307.34,146.05),unit=2), {10:None, 9:None})
C(s.add('Amplifier_Operational:LM13700','U15','LM13700',(307.34,165.1),unit=4), {7:None, 8:None})
